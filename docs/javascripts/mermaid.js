(function () {
    ...
    const iconify_material = fetch('https://unpkg.com/@iconify-json/material-symbols@1/icons.json').then((res) => res.json())
        .catch(e => console.error("Failed to fetch Mermaid icon pack:", e));
    const devicon = fetch('https://unpkg.com/@iconify-json/devicon@1/icons.json').then((res) => res.json())
        .catch(e => console.error("Failed to fetch Mermaid icon pack:", e));
    const simple_icons = fetch('https://unpkg.com/@iconify-json/simple-icons@1/icons.json').then((res) => res.json())
    .catch(e => console.error("Failed to fetch Mermaid icon pack:", e));
        ...
        set: async function (value) {
            ...
            try {
                value.registerIconPacks([
                    ...
                    { name: 'devicon', loader: () => devicon },
                    { name: 'simple-icons', loader: () => simple_icons },
                ]);
            } catch (e) {
